...
public class SimpleArrayNumWithExitCommands {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		System.out.println("** SimpleArrayNumWithExitCommands: using input from user with exit commands - START **");
		...
		System.out.println("** SimpleArrayNumWithExitCommands: using input from user with exit commands - END **");
	}
