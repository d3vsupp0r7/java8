...
public class FileTxtJUnitExample {
    ...
    public void testReadFileWithClassLoader(){
        ...
        File file = new File(classLoader.getResource("lorem_ipsum_txt/lorem_ipsum.txt").getFile());
    ...
    public void testReadFileWithResource() {
        URL url = this.getClass().getResource("/lorem_ipsum_txt/lorem_ipsum.txt");
    ...
    public void readFileRelativePath() {
        File file = new File("src/test/resources/lorem_ipsum_txt/lorem_ipsum.txt");
        assertTrue(file.exists());
    }
    
    @Test
    public void testReadAsStream() throws IOException{
        InputStream is = this.getClass().getResourceAsStream("/lorem_ipsum_txt/lorem_ipsum.txt");
        assertNotNull(is);
    }
    
    @Test
    public void testReadAsStreamFileNotExist() throws IOException{
