...
public class CF_4_7_Solution_use_exceptionally_chain_no_handler {
	...
	public static void main(String[] args) {
		...
		//.thenApply(integer -> integer + 10)// NOT EXECUTED
		.thenAccept(System.out::println) //NOT EXECUTED
		.join();//JOIN all excetution chain: An error in chain will printed for using join() method
	}
