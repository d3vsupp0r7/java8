...
public class MyWorkingSubreportExample
{
	...
	public static void main( String[] args ){
		System.out.println("** MyWorkingSubreportExample **");
		...
		try{
			...
			if (compileJRXML()){
				...
				try{
					...
					/*PDF out file*/
					JasperReport mainReportFileOut = JasperCompileManager.compileReport("C://jasperReport//java_beans_datasource_report.jrxml");	
					JasperExportManager.exportReportToPdfFile(jasperPrint, reportsDirName + "\\SubReportExample-Rpt.pdf");
					/**/
